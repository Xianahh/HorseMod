### **Horse Team License**<br>
Copyright © 2025 Horse Team (Albion, Alex, Carlesturo, Chuck, JBG_84, Paddlefruit, Sewerrabbit, SimKDT)
<br><br>
...
2. Your work does not contain or redistribute any of the original mod’s files or assets, except for the minimal data strictly necessary for the patch/translation/addon to function (e.g., a string table for translations, a lightweight compatibility config, an asset modification, modified code elements).
